export const INSTALL_MESSAGES = [
  "Resolving dependency tree of your life choices...",
  "Fetching packages from the void...",
  "Building fresh packages from source: regret",
  "warning: peer dependency conflict: sleep vs productivity",
  ...
  "added 9,847 packages in 47s",
];

export const ERROR_MESSAGES = [
  "npm ERR! Could not install motivation: package not found",
